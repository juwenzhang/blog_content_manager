<template>
  ...
  <PageContent
    ...
    :props-list="contentConfig.propsList"
...
import usePageModelHookReturnType from '@/hooks/usePageModelHook.ts'

const { contentRef, resetClickHandler, queryClickHandler } = usePageContentHookReturnType()
